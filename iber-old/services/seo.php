...
<body>
    ...
    <h1 style="display:none">Best SEO Company in kerala </h1>

    <h2 style="display:none">Best SEO Company in Calicut</h2>
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        ...
                                        <div class="d-flex align-items-center ">
                                            <a class='ht-btn' href="<?php echo BASE_URL; ?>Contact.html">Discover More
            ...
            <div class="row">
                    ...
                    <div class="row row-cols-md-2 mb-75" style="margin-top:85px !important;">
                        <div class="col d-flex justify-content-xl-start justify-content-center">
                            <div class="progressbar-content">
                                ...
                                <h3 class="progress-title">Business People</h3>
                            </div>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="text-wrapper-one mb-30">
                        ...
                        <a class='ht-btn w-100' href="<?php echo BASE_URL; ?>About.html">More About Us <span><i
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 service-head">
                    <!-- <h2>Our Services</h2> -->
                    <div class="slid_head">
                        <h2 class="slid_h2">Our Clients </h2>
...
filter: invert(22%) sepia(20%) saturate(2981%) hue-rotate(176deg) brightness(98%) contrast(95%);">
                        ...
                        <h4 class="service-title mb-10">KEYWORD RESEARCH
                        </h4>
...
filter: invert(22%) sepia(20%) saturate(2981%) hue-rotate(176deg) brightness(98%) contrast(95%);">
            ...
            <div class="row">
                <div class="col-12 text-center mt-35">
                    <a class='ht-btn ' href="<?php echo BASE_URL; ?>Services.html">See All Services <span><i
                                class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
        </div>
                ...
                <div class="accordion-item zoom zoom-in-right" style="transition-duration: 1s;">
                    ...
                    <div class="accordion-content">
                        ...
                        <table>
                            ...
                            <tbody>
                                   <tr>
                                    <td>ayurvedacolleges in kerala</td>
                                    <td>1st page</td>
                                </tr>
                                <tr>
                                    <td>ayurveda courses in palakkad</td>
                                    <td>1st page</td>
                                </tr>
                                <tr>
                                    <td>best ayurveda colleges in kerala</td>
                                    <td>1st page</td>
                                </tr>
                                <tr>
                                    <td>best ayurveda hospitalin palakkad</td>
                                    <td>1st page</td>
                                </tr>
                                <tr>
                                    <td>ayurvedichospital in palakkad</td>
                                    <td>1st page</td>
                                </tr>
                                <tr>
                                    <td>bestayurvedic hospitalin palakkad</td>
                                    <td>1st page</td>
                                </tr>
                            </tbody>
                        </table>
            ...
            accordions.forEach(acc => {
                acc.addEventListener('click', function () {
                    ...
                    if (panel.style.maxHeight) {
                        ...
                        this.classList.remove('active'); // Remove background when closing
                    } else {
                        panel.style.maxHeight = panel.scrollHeight + 'px';
                        icon.style.transform = 'rotate(180deg)';
                        this.classList.add('active'); // Apply background when opened
                    }
                });
            });
...
.quick_whtsp{
  ...
  .quick_call:hover{
    ...
    bottom: 5%;
    z-index: 999;
    background: linear-gradient(15deg, #0484BD, #023E59);
  }
  ...
  /* ================quick contact========================= */
        ...
        <a href="https://wa.me/9526536504"   class="quick_whtsp"><i class="fa-brands fa-whatsapp"></i></a>


        <a href="tel:+917907385121"  class="quick_call"><i class="fa-solid fa-phone"></i></a>
        
        <a href="#"  class="quick_top"><i class="fa-solid fa-arrow-up"></i></a>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-logo-area">
                        <img src="<?php echo BASE_URL; ?>assetsnew/img/logo/logo.png" alt="seo company">
                        ...
                        <ul>
                            <li><a href="https://www.facebook.com/iberrtech/"><img
                                        src="<?php echo BASE_URL; ?>assetsnew/img/icons/facebook.svg"
                                        alt=" seo company in calicut"></a></li>
                            <li><a href="https://www.instagram.com/iberrtechnologies/"><img
                                        src="<?php echo BASE_URL; ?>assetsnew/img/icons/instagram.svg"
                                        alt=" best seo company in calicut"></a></li>
                            <li><a
                                    href="https://www.linkedin.com/in/iberr-technologies-llp-101b77222/recent-activity/all/"><img
                                        src="<?php echo BASE_URL; ?>assetsnew/img/icons/linkedin.svg"
                                        alt=" best seo company  calicut"></a></li>
                            <!-- <li><a href="#"><img src="assetsnew/img/icons/youtube.svg" alt=""></a></li> -->
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer-logo-area2">
                        ...
                        <ul>
                            <li><a href="404-4"><img src="<?php echo BASE_URL; ?>assetsnew/img/icons/email.svg"
                                        alt="seo company"><span>iberrtech@gmail.com</span></a></li>
                            <li><a href="#"><img src="<?php echo BASE_URL; ?>assetsnew/img/icons/location.svg"
                                        alt="best seo company"><span><b>Kozhikode</b> <br
                                            class="d-lg-block d-none">Payyadimeetal,
                                        ...
                                        673019</span></a></li>
                            <li><a href="#"><img src="<?php echo BASE_URL; ?>assetsnew/img/icons/location.svg"
                                        alt="seo company in kozhikkode"><span><b>Malappuram</b> <br
                                            class="d-lg-block d-none"> NK Complex 1st
                            ...
                            <li><a href="tel:917907385121"><img
                                        src="<?php echo BASE_URL; ?>assetsnew/img/icons/phone.svg"
                                        alt="best seo company in kozhikkode"><span>7907385121</span></a></li>
                            <li><a href="tel:919526536504"><img
                                        src="<?php echo BASE_URL; ?>assetsnew/img/icons/phone.svg"
                                        alt="best seo"><span>9526536504</span></a></li>
